...
export const rolesColumns: ColumnDef<Role>[] = [
  ...
  },
  {
    ...
    size: 70,
    cell: ({ row }) => {
      const isSystemRole = row.original.group === "Built-in agents";
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-48" align="end">
            <DropdownMenuGroup>
              {needsReview ? <DropdownMenuItem>Review policy</DropdownMenuItem> : null}
              <DropdownMenuItem>View scope</DropdownMenuItem>
              <DropdownMenuItem disabled={isSystemRole}>Edit scope</DropdownMenuItem>
              <DropdownMenuItem disabled={isSystemRole}>Duplicate scope</DropdownMenuItem>
            </DropdownMenuGroup>
            <DropdownMenuSeparator />
            <DropdownMenuGroup>
              <DropdownMenuItem>Inspect actions</DropdownMenuItem>
              <DropdownMenuItem>Manage bindings</DropdownMenuItem>
            </DropdownMenuGroup>
            <DropdownMenuSeparator />
            <DropdownMenuGroup>
