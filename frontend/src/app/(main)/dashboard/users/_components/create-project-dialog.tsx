    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-xl">
        ...
        <div className="grid gap-3">
          <Input placeholder="Project name" value={form.name} onChange={(event) => updateField("name", event.target.value)} />
          <Input placeholder="Slug (optional)" value={form.slug} onChange={(event) => updateField("slug", event.target.value)} />
          <Textarea
